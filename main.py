...
def test_knn():
    ...
    for i, params in enumerate(params_list):
        ...
        # print("sk learn y_pred is",y_pred)
        # print("sk learn y_pred shape is", y_pred.shape)
        # print("k is",params['n_neighbors'])
        # print("metric is",params['weights'])
        ...
        # print("my model y_pred is",y_pred)
        # print("my model y_pred shape is", y_pred.shape)
        # print("neighbours are",params['n_neighbors'])
        # print("metric is",params['weights'])
...
def test_mlp():
    ...
    for i, params in enumerate(params_list):
        ...
        sklearn_model.fit(X_train_i, y_train_i)
        y_pred = sklearn_model.predict(X_test_i)
        # print("true labels of iris are", y_test_i)
        ...
        my_model.fit(X_train_i, y_train_i)
        y_pred = my_model.predict(X_test_i)
        # print("accuracy is",accuracy_score(y_test_i, y_pred))
    ...
    for i, params in enumerate(params_list):
        ...
        # print("true labels are",y_test_d)
    print('\n')
